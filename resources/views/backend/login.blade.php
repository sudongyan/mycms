...
<head>
    ...
    <title>登录 - {{ config('app.name', 'CMS')  }}</title>
    <script>
    ...
    <!-- Styles -->
    <link href="{{asset('cms/plugins/zui/css/zui.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('cms/css/app.css')}}" rel="stylesheet" type="text/css">
