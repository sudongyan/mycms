...
@if( 'simditor' == $editor )
<script type="text/javascript"  src="{{ asset('cms/plugins/editor/js/module.js') }}"></script>
<script type="text/javascript"  src="{{ asset('cms/plugins/editor/js/hotkeys.js') }}"></script>
<script type="text/javascript"  src="{{ asset('cms/plugins/editor/js/uploader.js') }}"></script>
<script type="text/javascript"  src="{{ asset('cms/plugins/editor/js/simditor.js') }}"></script>
<script type="text/javascript"  src="{{ asset('cms/plugins/editor/js/beautify-html.min.js') }}"></script>
<script type="text/javascript"  src="{{ asset('cms/plugins/editor/js/simditor-html.js') }}"></script>
<script type="text/javascript"  src="{{ asset('cms/plugins/editor/js/to-markdown.js') }}"></script>
<script type="text/javascript"  src="{{ asset('cms/plugins/editor/js/marked.min.js') }}"></script>
<script type="text/javascript"  src="{{ asset('cms/plugins/editor/js/simditor-markdown.js') }}"></script>
<script>
...
<script type="text/javascript"  src="{{ asset('cms/plugins/ueditor/ueditor.config.js') }}"></script>
<script type="text/javascript"  src="{{ asset('cms/plugins/ueditor/ueditor.all.min.js') }}"></script>
<script type="text/javascript"  src="{{ asset('cms/plugins/ueditor/lang/zh-cn/zh-cn.js') }}"></script>
<script>
