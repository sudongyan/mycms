...
@section('styles')
    <link rel="stylesheet" href="{{asset('cms/plugins/ztree/css/zTreeStyle/zTreeStyle.css')}}">
@endsection

@section('scripts')
    <script type="text/javascript" src="{{asset('cms/plugins/ztree/js/jquery.ztree.core.js')}}"></script>
    <script type="text/javascript" src="{{asset('cms/plugins/ztree/js/jquery.ztree.excheck.js')}}"></script>
