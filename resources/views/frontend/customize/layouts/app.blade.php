...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>@yield('title', config('system.common.basic.name', 'CMS')) - {{ config('system.common.basic.name', config('app.name', 'CMS')) }}</title>
        ...
        <!-- Styles -->
        <link href="{{asset('cms/plugins/layui/css/layui.css')}}" rel="stylesheet" type="text/css">
        <link href="{{asset('cms/css/website.css')}}" rel="stylesheet" type="text/css">
    ...
    <body  class="{{ route_class() }}-body">
        ...
        <!-- Scripts -->
        <script src="{{asset('cms/plugins/layui/layui.all.js')}}"></script>
        <script src="{{asset('cms/js/website.js')}}"></script>
