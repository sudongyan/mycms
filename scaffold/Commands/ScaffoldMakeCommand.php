 ...
 * @package   Laravel
 */
namespace Cms\Generator\Commands;

use Illuminate\Console\Command;
use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Input;
use Cms\Generator\Makes\MakeController;
use Cms\Generator\Makes\MakeLayout;
use Cms\Generator\Makes\MakeLocalization;
use Cms\Generator\Makes\MakeMigration;
use Cms\Generator\Makes\MakeModel;
use Cms\Generator\Makes\MakeRoute;
use Cms\Generator\Makes\MakerTrait;
use Cms\Generator\Makes\MakeSeed;
use Cms\Generator\Makes\MakeView;
use Cms\Generator\Makes\MakeFormRequest;
use Cms\Generator\Makes\MakePolicy;
use Cms\Generator\Makes\MakeModelObserver;
...
class ScaffoldMakeCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Create a laraval lib scaffold';
        ...
        return
            [
                ...
                [
                    ...
                    'UI Framework to generate scaffold. (Default lay - zui)',
                    'zui'
                ],
                [
                    'validator',
